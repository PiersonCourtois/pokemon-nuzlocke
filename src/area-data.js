export const gameData = [
  {
    ...
    "encounters-scarlet": ["Sprigatito", "Fuecoco", "Quaxly"],

    "encounters-violet": ["Sprigatito", "Fuecoco", "Quaxly"]
  },
  {
    "name": "Poco Path",

    "encounters-scarlet": ["Fletchling", "Hoppip", "Lechonk", "Pawmi", "Scatterbug", "Tarountula", "Yungoos"],

    "encounters-violet": ["Fletchling", "Hoppip", "Lechonk", "Pawmi", "Scatterbug", "Tarountula", "Yungoos"]
  },
  {
    "name": "Inlet Grotto",

    "encounters-scarlet": ["Diglett", "Yungoos", "Houndour"],

    "encounters-violet": ["Diglett", "Yungoos", "Houndour"]
  },
  {
    "name": "South Province (Area One)",

    "encounters-scarlet": ["Azurill", "Buizel", "Chewtle", "Fidough", "Happiny", "Hoppip", "Igglybuff", "Lechonk", "Magikarp", "Pachirisu", "Psyduck", "Scatterbug", "Skwovet", "Tarountula", "Wiglett", "Wingull"],

    "encounters-violet": ["Azurill", "Buizel", "Chewtle", "Fidough", "Happiny", "Hoppip", "Igglybuff", "Lechonk", "Magikarp", "Pachirisu", "Psyduck", "Scatterbug", "Skwovet", "Tarountula", "Wiglett", "Wingull"]
  },
  {
    "name": "South Province (Area Two)",

    "encounters-scarlet": ["Azurill", "Bonsly", "Buizel", "Chewtle", "Combee", "Diglett", "Fidough", "Fletchling", "Happiny", "Hoppip", "Igglybuff", "Jigglypuff", "Kricketot", "Magikarp", "Makuhita", "Mareep", "Maschiff", "Nacli", "Meowth", "Pichu", "Pikachu", "Psyduck", "Rockruff", "Skwovet", "Smoliv", "Starly", "Sunkern", "Yungoos"],

    "encounters-violet": ["Azurill", "Bonsly", "Buizel", "Chewtle", "Combee", "Diglett", "Fidough", "Fletchling", "Happiny", "Hoppip", "Igglybuff", "Jigglypuff", "Kricketot", "Magikarp", "Makuhita", "Mareep", "Maschiff", "Nacli", "Meowth", "Pichu", "Pikachu", "Psyduck", "Rockruff", "Skwovet", "Smoliv", "Starly", "Sunkern", "Yungoos"]
  },
  {
    "name": "South Province (Area Three)",

    "encounters-scarlet": ["Bronzor", "Charcadet", "Drowzee", "Dunsparce", "Growlithe",  "Happiny", "Jigglypuff", "Klawf", "Makuhita", "Murkrow", "Nacli", "Nymble", "Oricorio", "Pawmi", "Rookidee", "Shinx", "Skiddo", "Spoink", "Squawkabilly", "Tinkatink", "Yungoos"],

    "encounters-violet": ["Bronzor", "Charcadet", "Drowzee", "Dunsparce", "Growlithe", "Gulpin", "Happiny", "Jigglypuff", "Klawf", "Makuhita", "Murkrow", "Nacli", "Nymble", "Oricorio", "Pawmi", "Rookidee", "Shinx", "Skiddo", "Spoink", "Squawkabilly", "Tinkatink", "Yungoos"]
  },
  {
    "name": "East Province (Area One)",

    "encounters-scarlet": ["Corvisquire", "Deerling", "Dunsparce", "Hoppip", "Komala", "Lechonk", "Litleo", "Oinkologne", "Pikachu", "Rookidee", "Shroodle", "Spidops", "Squawkabilly", "Steenee", "Tadbulb", "Tandemaus", "Tauros", "Teddiursa", "Tarountula", "Venonat"],

    "encounters-violet": ["Corvisquire", "Deerling", "Dunsparce", "Gulpin", "Hoppip", "Komala", "Lechonk", "Litleo", "Oinkologne", "Pikachu", "Rookidee", "Shroodle", "Spidops", "Squawkabilly", "Steenee", "Tadbulb", "Tandemaus", "Teddiursa", "Tarountula", "Venonat"],

    "encounters-scarlet-night": ["Corvisquire", "Deerling", "Dunsparce", "Hoppip", "Komala", "Lechonk", "Litleo", "Oinkologne", "Pikachu", "Rookidee", "Shroodle", "Spidops", "Squawkabilly", "Steenee", "Tadbulb", "Tandemaus", "Tauros", "Teddiursa", "Tarountula", "Venonat", "Shuppet", "Murkrow"],

    "encounters-violet-night": ["Corvisquire", "Deerling", "Dunsparce", "Gulpin", "Hoppip", "Komala", "Lechonk", "Litleo", "Oinkologne", "Pikachu", "Rookidee", "Shroodle", "Spidops", "Squawkabilly", "Steenee", "Tadbulb", "Tandemaus", "Teddiursa", "Tarountula", "Venonat", "Shuppet", "Murkrow"]
  },
  {
  ...
  },
  {
    ...
    "encounters-scarlet": ["Axew", "Bagon", "Buizel", "Chewtle", "Clodsire", "Corvisquire", "Crabrawler", "Deerling", "Dunsparce", "Flamigo", "Fletchinder", "Flittle", "Gumshoos", "Hoppip", "Litleo", "Luxio", "Magikarp", "Mankey", "Marill", "Masquerain", "Mudbray", "Nacli", "Oinkologne", "Pachirisu", "Pawmi", "Pincurchin", "Psyduck", "Rockruff", "Rookidee", "Sandygast", "Seviper", "Shellos", "Shroomish", "Seviper", "Skiddo", "Skiploom", "Slowpoke", "Stantler", "Surskit", "Swablu", "Tadbulb", "Tarountula", "Vigoroth", "Wattrel", "Wiglett", "	Wooper", "Yungoos", "Zangoose"],
  ...
  },
  {
    ...
    "encounters-scarlet": ["Bramblin", "Braviary", "Bronzor", "Buizel", "Cacnea", "Cacturne", "Capsakid", "Cyclizar", "Donphan", "Espathra", "Falinks", "Flittle", "Hippopotas", "Hippowdon", "Larvesta", "Makuhita", "Nacli", "Phanpy", "Psyduck", "Rellor", "Rufflet", "Sandaconda", "Sandile", "Sandygast", "Silicobra", "Tadbulb", "Tinkatink", "Tinkatuff"],

    "encounters-violet": ["Bramblin", "Braviary", "Bronzor", "Buizel", "Cacnea", "Cacturne", "Capsakid", "Cyclizar", "Donphan", "Espathra", "Falinks", "Flittle", "Hippopotas", "Hippowdon", "Larvesta", "Makuhita", "Nacli", "Phanpy", "Psyduck", "Rellor", "Rufflet", "Sandaconda", "Sandile", "Sandygast", "Silicobra", "Tadbulb", "Tinkatink", "Tinkatuff"]
  },
  {
  ...
  },
  {
    ...
    "encounters-scarlet": ["Bagon", "Basculin", "Bramblin", "Buizel", "Carkol", "Chewtle", "Corvisquire", "Cufant", "Diglett", "Dugtrio", "Falinks", "Growlithe", "Hariyama", "Kirlia", "Magikarp", "Magnemite", "Makuhita", "Meowth", "Nacli", "Orthworm", "Pawniard", "Psyduck", "Pyroar", "Rolycoly", "Rookidee", "Rufflet", "Salandit", "Silicobra", "Squawkabilly", "Tadbulb", "Torkoal", "Varoom", "Voltorb", "Yungoos"],
  ...
  },
  {
    ...
    "encounters-scarlet": ["Arrokuda", "Flamigo", "Foongus", "Grafaiai", "Greedent", "Impidimp", "Komala", "Mimikyu", "Morgrem", "Oinkologne", "Pawniard", "	Psyduck", "Shroodle", "Skwovet", "Spidops", "Tadbulb", "Venonat", "Zorua"],
  ...
  },
  {
    ...
    "encounters-scarlet": ["Altaria", "Banette", "Basculin", "Bombirdier", "Bronzong", "Dachsbun", "Donphan", "Espathra", "Fidough", "Flaaffy", "Flittle", "Gallade", "Gogoat", "Gothorita", "Greedent", "Gumshoos", "Hypno", "Klefki", "Lokix", "Lycanroc", "Meditite", "Mudbray", "Mudsdale", "Nacli", "Naclstack", "Psyduck", "Rufflet", "Scovillain", "Sinistea", "Skwovet", "Swablu", "Tinkatuff", "Toxtricity", "Yungoos"],

    "encounters-violet": ["Altaria", "Banette", "Basculin", "Bombirdier", "Bronzong", "Dachsbun", "Donphan", "Espathra", "Fidough", "Flaaffy", "Flittle", "Gallade", "Gogoat", "Gothorita", "Greedent", "Gumshoos", "Hypno", "Klefki", "Lokix", "Lycanroc", "Meditite", "Mudbray", "Mudsdale", "Nacli", "Naclstack", "Psyduck", "Rufflet", "Scovillain", "Sinistea", "Skwovet", "Swablu", "Tinkatuff", "Toxtricity", "Yungoos"],

    "encounters-scarlet-night":["Altaria", "Banette", "Basculin", "Bombirdier", "Bronzong", "Dachsbun", "Donphan", "Espathra", "Fidough", "Flaaffy", "Flittle", "Gallade", "Gogoat", "Gothorita", "Greedent", "Gumshoos", "Hypno", "Klefki", "Lokix", "Lycanroc", "Meditite", "Mudbray", "Mudsdale", "Nacli", "Naclstack", "Psyduck", "Rufflet", "Scovillain", "Sinistea", "Skwovet", "Swablu", "Tinkatuff", "Toxtricity", "Yungoos", "Murkrow", "Honchkrow"],

    "encounters-violet-night": ["Altaria", "Banette", "Basculin", "Bombirdier", "Bronzong", "Dachsbun", "Donphan", "Espathra", "Fidough", "Flaaffy", "Flittle", "Gallade", "Gogoat", "Gothorita", "Greedent", "Gumshoos", "Hypno", "Klefki", "Lokix", "Lycanroc", "Meditite", "Mudbray", "Mudsdale", "Nacli", "Naclstack", "Psyduck", "Rufflet", "Scovillain", "Sinistea", "Skwovet", "Swablu", "Tinkatuff", "Toxtricity", "Yungoos", "Murkrow", "Misdreavus", "Honchkrow"]
  },
  {
    "name": "Alfornada Cavern",

    "encounters-scarlet": ["Glimmet","Naclstack","Lokix","Mudsdale","Mudbray","Lycanroc","Gumshoos","Deino","Gallade","Drifblim","Banette","Altaria","Pupitar", "Larvitar", "Ampharos", "Diglett", "Dugtrio", "Dunsparce", "Gabite", "Gible", "Hariyama", "Hawlucha", "Houndoom", "Makuhita", "Medicham", "Meditite", "Sableye", "Salandit", "Salazzle", "Toxtricity", "Umbreon"],

    "encounters-violet": ["Glimmet","Naclstack","Lokix","Mudsdale","Mudbray","Lycanroc","Gumshoos","Deino","Gallade","Drifblim","Bagon","Banette","Altaria","Pupitar", "Larvitar", "Ampharos", "Diglett", "Dugtrio", "Dunsparce", "Gabite", "Gible", "Hariyama", "Hawlucha", "Houndoom", "Makuhita", "Medicham", "Meditite", "Sableye", "Salandit", "Salazzle", "Shelgon", "Toxtricity", "Umbreon"]
  },
  {
    "name": "Dalizapa Passage",

    "encounters-scarlet": ["Axew", "Bagon", "Cetoddle", "Cubchoo", "Deerling", "Dunsparce", "Dugtrio", "Espathra", "Flittle", "Glimmet", "Gogoat", "Greavard", "Greedent", "Gumshoos", "Hariyama", "Houndstone", "Litleo", "Lokix", "Lucario", "Lycanroc", "Makuhita", "Medicham", "Mudbray", "Nacli", "Naclstack", "Pyroar", "Rufflet", "Sableye", "Salandit", "Scovillain", "Skwovet", "Sneasel", "Snom", "Snorunt", "Teddiursa", "Torkoal", "Ursaring", "Vigoroth"],

    "encounters-violet": ["Axew", "Bagon", "Cetoddle", "Cubchoo", "Deerling", "Dunsparce", "Dugtrio", "Espathra", "Flittle", "Glimmet", "Gogoat", "Greavard", "Greedent", "Gumshoos", "Hariyama", "Houndstone", "Litleo", "Lokix", "Lucario", "Lycanroc", "Makuhita", "Medicham", "Mudbray", "Nacli", "Naclstack", "Pyroar", "Rufflet", "Sableye", "Salandit", "Scovillain", "Skwovet", "Sneasel", "Snom", "Snorunt", "Teddiursa", "Torkoal", "Ursaring", "Vigoroth"],

    "encounters-scarlet-night": ["Axew", "Bagon", "Cetoddle", "Cubchoo", "Deerling", "Dunsparce", "Dugtrio", "Espathra", "Flittle", "Glimmet", "Gogoat", "Greavard", "Greedent", "Gumshoos", "Hariyama", "Houndstone", "Litleo", "Lokix", "Lucario", "Lycanroc", "Makuhita", "Medicham", "Mudbray", "Nacli", "Naclstack", "Pyroar", "Rufflet", "Sableye", "Salandit", "Scovillain", "Skwovet", "Sneasel", "Snom", "Snorunt", "Teddiursa", "Torkoal", "Ursaring", "Vigoroth"],

    "encounters-violet-night": ["Axew", "Bagon", "Cetoddle", "Cubchoo", "Deerling", "Dunsparce", "Dugtrio", "Espathra", "Flittle", "Glimmet", "Gogoat", "Greavard", "Greedent", "Gumshoos", "Hariyama", "Houndstone", "Litleo", "Lokix", "Lucario", "Lycanroc", "Makuhita", "Medicham", "Mudbray", "Nacli", "Naclstack", "Pyroar", "Rufflet", "Sableye", "Salandit", "Scovillain", "Skwovet", "Sneasel", "Snom", "Snorunt", "Teddiursa", "Torkoal", "Ursaring", "Vigoroth", "Misdreavus"]
  },
  {
    "name": "Glaseado Mountain",

    "encounters-scarlet": ["Abomasnow", "Avalugg", "Axew", "Beartic", "Bergmite", "Bronzong", "Cetoddle", "Crabominable", "Cryogonal", "Cubchoo", "Cufant", "Deerling", "Delibird", "Donphan", "Espathra", "Flareon", "Flittle", "Fraxure", "Froslass", "Gardevoir", "Glaceon", "Gogoat", "Golduck", "Greavard", "Greedent", "Grumpig", "Hariyama", "Houndstone", "Litleo", "Lokix", "Lycanroc", "Magnemite", "Magneton", "Makuhita", "Mudbray", "Nacli", "Naclstack", "Phanpy", "Psyduck", "Pyroar", "Ralts", "Rufflet", "Sawsbuck", "Scovillain", "Skwovet", "Sneasel", "Snom", "Snover", "Snorunt", "Spoink", "Teddiursa", "Tinkatuff", "Ursaring", "Vigoroth"],
  ...
  },
  {
    ...
    "encounters-scarlet": ["Bronzong", "Buizel", "Chansey", "Dugtrio","Flamigo", "Floatzel", "Floette", "Fomantis", "Gabite", "Gastrodon", "Gible", "Glalie", "Golduck", "Gyarados", "Hawlucha", "Hoppip", "Jumpluff", "Kilowattrel", "Lurantis", "Luvdisc", "Pawmi", "Pawmo", "Pincurchin", "Sableye", "Sunflora", "Sylveon", "Vaporeon", "Vivillon", "Wugtrio"],

    "encounters-violet": ["Bronzong", "Buizel", "Chansey", "Clawitzer", "Dugtrio", "Eiscue", "Flamigo", "Floatzel", "Floette", "Fomantis", "Gabite", "Gastrodon", "Gible", "Glalie", "Golduck", "Gyarados", "Hawlucha", "Hoppip", "Jumpluff", "Kilowattrel", "Lurantis", "Luvdisc", "Pawmi", "Pawmo", "Pincurchin", "Sableye", "Sunflora", "Sylveon", "Vaporeon", "Vivillon", "Wugtrio"]
  },
  {
    "name": "North Province (Area One)",

    "encounters-scarlet": ["Altaria", "Axew", "Chansey", "Deerling", "Dratini", "Espathra", "Flareon", "Floette", "Fraxure", "Gogoat", "Golduck", "Greavard", "Hawlucha", "Houndstone", "Indeedee", "Lokix", "Lycanroc", "Pawmi", "Pawmo", "Nacli", "Naclstack", "Noibat", "Rufflet", "Salazzle", "Sawsbuck", "Scovillain", "Swablu", "Bronzong", "Teddiursa", "Tinkatuff", "Ursaring"],
  ...
  },
  {
    ...
    "encounters-scarlet": ["Amoonguss", "Arcanine", "Bisharp", "Corviknight", "Dratini",  "Falinks", "Foongus", "Golduck", "Growlithe", "Kricketot", "Kricketune", "Heracross", "Lokix", "Luxray", "Pawniard", "Scyther", "Slaking", "Spidops", "Teddiursa", "Ursaring", "Venomoth"],

    "encounters-violet": ["Amoonguss", "Arcanine", "Bisharp", "Corviknight", "Drakloak", "Dratini", "Dreepy", "Falinks", "Foongus", "Golduck", "Growlithe", "Kricketot", "Kricketune", "Heracross", "Lokix", "Luxray", "Passimian", "Pawniard", "Scyther", "Slaking", "Spidops", "Teddiursa", "Ursaring", "Venomoth"]
  },
  {
    "name": "Socarrat Trail",
  ...
  },
  {
    ...
    "encounters-scarlet": ["Altaria", "Avalugg", "Azumarill", "Bergmite", "Bronzong", "Chewtle", "Croagunk", "Dondozo", "Dratini", "Drednaw","Flamigo", "Golduck", "Goomy", "Gyarados", "Lokix", "Marill", "Scyther", "Sliggoo", "Slowbro", "Slowpoke", "Staraptor", "Swablu", "Tatsugiri", "Toxicroak", "Tropius", "Vaporeon", "Veluza", "Venomoth"],

    "encounters-violet": ["Altaria", "Avalugg", "Azumarill", "Bergmite", "Bronzong", "Chewtle", "Croagunk", "Dondozo", "Drakloak", "Dratini", "Drednaw", "Dreepy", "Flamigo", "Golduck", "Goomy", "Gulpin", "Gyarados", "Lokix", "Marill", "Scyther", "Sliggoo", "Slowbro", "Slowpoke", "Staraptor", "Swablu", "Swalot", "Tatsugiri", "Toxicroak", "Tropius", "Vaporeon", "Veluza", "Venomoth"]
  },
  {
  ...
  },
  {
    ...
    "encounters-scarlet": ["Bisharp", "Braviary", "Buizel", "Chansey", "Corviknight", "Dugtrio", "Dudunsparce", "Dunsparce", "Espathra", "Espeon", "Farigiraf", "Flamigo", "Floatzel", "Floette", "Frosmoth", "Gabite", "Garganacl", "Gible", "Girafarig", "Glimmet", "Glimmora", "Gogoat", "Golduck", "Hawlucha", "Iron Bundle", "Iron Jugulis", "Jumpluff", "Lokix", "Lycanroc", "Magnezone", "Masquerain", "Nacli", "Naclstack", "Pawmi", "Pawmo", "Raichu", "Sableye", "Sneasel", "Tadbulb", "Talonflame", "Venomoth", "Volcarona", "Weavile", "Slither Wing", "Scream Tail", "Brute Bonnet", "Sandy Shocks", "Zweilous", "Great Tusk", "Flutter Mane", "Roaring Moon"],

    "encounters-violet": ["Bisharp", "Braviary", "Buizel", "Chansey", "Corviknight", "Drakloak", "Dreepy", "Dugtrio", "Dudunsparce", "Dunsparce", "Espathra", "Espeon", "Farigiraf", "Flamigo", "Floatzel", "Floette", "Frosmoth", "Gabite", "Garganacl", "Gible", "Girafarig", "Glimmet", "Glimmora", "Gogoat", "Golduck", "Hawlucha", "Iron Bundle", "Iron Jugulis", "Jumpluff", "Lokix", "Lycanroc", "Magnezone", "Masquerain", "Nacli", "Naclstack", "Pawmi", "Pawmo", "Raichu", "Sableye", "Sneasel", "Tadbulb", "Talonflame", "Venomoth", "Volcarona", "Weavile", "Iron Hands", "Iron Moth", "Iron Thorns", "Iron Valiant"]
  }
]
